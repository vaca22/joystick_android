...
public class JoystickView extends View implements Runnable {
    ...
    protected void initJoystickView() {
        ...
        mainCircle.setColor(Color.argb(100, 150, 100, 100));
        mainCircle.setStyle(Paint.Style.FILL_AND_STROKE);

        secondaryCircle = new Paint();
        secondaryCircle.setColor(Color.argb(100, 0, 255, 0));
        secondaryCircle.setStyle(Paint.Style.STROKE);

        verticalLine = new Paint();
        verticalLine.setStrokeWidth(2);
        verticalLine.setColor(Color.argb(100, 0, 0, 0));

        horizontalLine = new Paint();
        horizontalLine.setStrokeWidth(2);
        horizontalLine.setColor(Color.argb(100, 0, 0, 0));

        button = new Paint(Paint.ANTI_ALIAS_FLAG);
        button.setColor(Color.argb(100, 0, 0, 255));
